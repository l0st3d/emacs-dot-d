...
(defun ed-clojure/compile-after-save ()
  ...
  ;;            (string-match ".*/build.boot$" (buffer-file-name))
  ;;            (cider-connected-p))
  ;;    (cider-load-buffer))
  (when (and (eq major-mode 'clojure-mode)
...
(defun ed-clojure/bind-keys ()
  ...
  (define-key clojure-mode-map (kbd "C-c h") 'paredit-raise-sexp)
  ...
  (define-key clojure-mode-map (kbd "C-c 9") 'paredit-backward-slurp-sexp)
  (define-key clojure-mode-map (kbd "C-c 0") 'paredit-forward-slurp-sexp)
  (define-key clojure-mode-map (kbd "C-c (") 'paredit-backward-barf-sexp)
  (define-key clojure-mode-map (kbd "C-c )") 'paredit-forward-barf-sexp)
  (define-key clojure-mode-map (kbd "C-c M-9") 'paredit-backward-barf-sexp)
  (define-key clojure-mode-map (kbd "C-c M-0") 'paredit-forward-barf-sexp)
  (define-key clojure-mode-map (kbd "C-c C-M-9") 'paredit-backward-barf-sexp)
  (define-key clojure-mode-map (kbd "C-c C-M-0") 'paredit-forward-barf-sexp)
  ...
  (subword-mode 1)
  (define-key clojure-mode-map (kbd "C-c r") 'hydra-cljr-code-menu/body))
